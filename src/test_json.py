...
print(type(s),s) # ["yeeku", {"favorite": ["coding", null, "game", 25]}]
# 简单的Python字符串转JSON
...
f = open('/Users/chweiqiang/Downloads/a.json', 'w')
...
print(type(result1),result1) # ['yeeku', {'favorite': ['coding', None, 'game', 25]}]
# 将JSON字符串恢复成Python字符串
result2 = json.loads('"\\"foo\\"bar"')
print(type(result2),result2) # "foo"bar
# 定义一个自定义的转化函数
def as_complex(dct):
...
result3 = json.loads('[{"__complex__": false, "real": 1, "imag": 2, "other":3},{"__complex__": false, "real": 5, "imag": 6}]',\
    object_hook=as_complex)
print(type(result3),result3) # (1+2j)
f = open('/Users/chweiqiang/Downloads/a.json')
# 从文件流恢复JSON列表
result4 = json.load(f)
